...
from bereshit.addons.PPO.essentials import ServoMovment
...
leg = GameObject(size=Vector3(), children=[feet, mount, servo1, servo2, calf, mount2, knee, thigh, hip1, hip2]).add_component(ServoMovment(servo1))

scene = [floor, wall1, wall2, wall3, wall4, leg, goal, cam]

Core.run(scene, tick=1/240)